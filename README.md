...
The `rexgend` data-path protocol (pipe and SocketCAN frame/text formats) is fully specified in [examples/named-pipes/README.md](examples/named-pipes/README.md) and [examples/socketcan/README.md](examples/socketcan/README.md).
